...
// 💡 CRITICAL PRODUCTION FIX: Forces Next.js to fetch fresh MongoDB data on every request
...
export default async function AdminAssignmentsPage() {
  ...
  // Directly pull plain data objects from your database instance
      ...
      <div className="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm">
        {assignments.length > 0 ? (
          ...
          <div className="p-16 text-center text-slate-400 font-medium">
            No assignments have been published yet. Click the button above to get started.
          </div>
        )}
      </div>
    </div>
